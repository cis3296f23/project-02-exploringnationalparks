                            ...
                            <p className="description">{park.description}</p>
                                <div
                                    className={`weatherContainer ${
                                        (park.weather.current.weather_code === 0) ? 'sunny' :
                                            [71, 73, 75, 77, 85, 86].includes(park.weather.current.weather_code) ? 'snowy' :
                                                [95, 96, 99].includes(park.weather.current.weather_code) ? 'stormy' :
                                                    [51, 53, 55, 56, 57, 61, 63, 65, 66, 67, 80, 81, 82].includes(park.weather.current.weather_code) ? 'rainy' :
                                                        'cloudy'
                                    }`}
                                >
                                    ...
                                    <img
                                        src={
                                            (park.weather.current.weather_code === 0) ? sunIcon :
